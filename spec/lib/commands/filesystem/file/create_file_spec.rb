...
describe Console::Commands::CreateFile do
  ...
  describe '.build!' do
    ...
    context 'validations' do
      ...
      include_examples 'valid', 'create_file new_file \'its content\''
      include_examples 'valid', 'create_file new_file \'its content\' -type=awesome'

      include_examples 'invalid by invalid namespace', 'create_file folder_level_1 \'content\''
      include_examples 'invalid by invalid path', 'create_file unknow/new_file \'its content\''
      include_examples 'invalid by exceptional arguments', 'create_file / \'its content\''
